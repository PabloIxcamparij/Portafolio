...
export default function SpaceProject({ project }) {
  return (
    <div className="flex flex-col sm:flex-row gap-8 w-full bg-gray-900/80 rounded-2xl p-6 shadow-xl backdrop-blur-sm animate-fadeIn">
      ...
      <div className="flex flex-wrap justify-center items-center sm:flex-col gap-6 w-full">
        <img
          ...
          alt={project.title}
          loading="lazy"
          className="w-[240px] h-[140px] sm:w-[320px] sm:h-[180px] md:w-[500px] lg:h-[250px] object-cover rounded-2xl"
        />
